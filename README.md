...
Pre-trained models have been put into the `model` folder. Please be remind that functions inclusion is automatically done in `addAll.m` script. If you directly do testing, don't forget to add all required paths.
